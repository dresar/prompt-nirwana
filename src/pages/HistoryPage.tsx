...
import { History, Image, Video, Users, Sparkles, MinusCircle, Trash2, Heart, Loader2 } from 'lucide-react';
      ...
      <div className="space-y-6 animate-fade-in">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Lihat semua prompt yang pernah Anda buat
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex gap-1">
                      ...
                      <Button
                        variant="ghost"
                        size="icon-sm"
                        onClick={() => toggleFavorite(item.id, item.is_favorite || false)}
                        className={item.is_favorite ? 'text-destructive' : ''}
                      >
        ...
        <Card variant="glass">
          <CardContent>
            <EmptyState
              ...
              description="Prompt yang Anda buat akan muncul di sini. Mulai dengan membuat prompt gambar atau video!"
            />
          </CardContent>
        </Card>
      )}
